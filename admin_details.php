...
<a href="logout.php" > <span id="logout"><b>logout</b></span></a>
			</div>
	</div>
</div>
         <div class='row' id='Landing-screen'>
          ...
          <br><br><br>
          <a href="HTTP://FCI.GOV.IN" class="button">Old Stock Details</a>
          
          <br><br><br>
          <a class="button" href="admin.php" >Real Time Data</a>
        <br><br>
        <a href="https://thingspeak.com/apps/plugins/220633" class="button">GAUGE VIEW</a><br>
        <br><br>
        <br><br><br
         <div class='container'>

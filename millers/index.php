...
$query = "SELECT * from `millerlogin` where username = '$username'";
$result = mysqli_query($connection,$query);
if(mysqli_num_rows($result)){
  session_start();
  $_SESSION['miller'] = 'true';
...
<!-- Mirrored from fcidepotonline.gov.in/millers/login by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Mar 2018 04:09:09 GMT -->
...
<script>
    ...
    <link href="../css/nav5e1f.css?v=2" rel="stylesheet" type="text/css" />
...
<div id="wrap">
	...
	<div id="title">
		...
		<div id="contentliquid">
			<div class="container">
         		<h3>Sign into the Depot Online System with Miller Id:</h3>

         	 <form name='loginForm' action="" method="post" autocomplete="off">
					<div class="row">
						<div class="col-md-12 col-sm-12 col-xs-12">
							<label for="username" class="control-label"> Miller ID:</label>
						</div>
						<div class="col-md-12 col-sm-12 col-xs-12">
...
<!-- Mirrored from fcidepotonline.gov.in/millers/login by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Mar 2018 04:09:11 GMT -->
</html>
